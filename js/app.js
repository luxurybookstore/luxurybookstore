...
function generatebooks() {
  ...
  new Book('images/The Principles of Uncertainty.png', 'The Principles of..', 'Art', 'An irresistible invitation to experience life through a beloved artist?s psyche, The Principles of Uncertainty is a compilation of Maira Kalman?s New York Times columns. Part personal narrative, part documentary, part travelogue, part chapbook, and all Kalman, these brilliant, whimsical paintings, ideas, and images?which initially appear random?ultimately form an intricately interconnected worldview, an idiosyncratic inner monologue.', 15);
  ...
  new Book('images/Wealth Secrets of the One Percent.png', 'Wealth Secrets of..', 'Business', 'From the richest Romans to the robber barons to today\'s bankers and tech billionaires, Sam Wilkin offers Freakonomics-esque insights into what it really takes to make a fortune. These stories of larger-than-life characters, strategies, and sacrifices reveal how the wealthiest did it, usually by a passion for finding loopholes, working around bureaucratic systems, and creating obstacles to competitors.', 52);
